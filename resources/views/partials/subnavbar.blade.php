<nav id="mainsubNavbar" class="navbar navbar-expand-lg navbar-light sticky-top w-100" style="background: rgba(0, 48, 122, 0.95);">
    ...
    <div id="mobileSidebar" class="position-fixed top-0 end-0 vh-100 shadow-lg">
        ...
        <ul class="navbar-nav text-end px-3">
            ...
            <li class="nav-item"><a class="nav-link text-white" href="{{ route('contact') }}    ">Kontak Kami</a></li>
        </ul>
    </div>
</nav>
